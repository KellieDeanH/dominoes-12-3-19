...
private:
	T elementoRepetido;
public:
	explicit ElementAlreadyExistsException(T elemento_repetido, const char* pStr = "Element already exsist!") :
...
public:
	explicit ElementDoesntExistsException(T elementoInexistente, const char* pStr = "Element does not exsist!") :
...
public:
	explicit EmptyContainerException(const char* pStr = "\nThe container you are trying to access is empty!") : Exceptions(pStr) {}
...
public:
	explicit CorruptedFileException(const char* pStr = "\nFile with corrupted data!") : Exceptions(pStr) {}
	string getFilename() const { return filename; }
...
public:
	explicit ExOutOfRange(const char* pStr = "Value outside vector domain!") : Exceptions(pStr) {}
...
public:
	explicit ExNoInterval(const char* pStr = "The interval begins and ends at zero!") : Exceptions(pStr) {}
