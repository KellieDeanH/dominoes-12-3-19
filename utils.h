 ...
 */
template <class Tipo>
Tipo getNumberCin(const char* message, Tipo size = UINT_MAX, Tipo min = 0, bool menu = false, const char* error_message = "Number out of range!") {
 ...
 */
bool getYesNoCin(const char* message, const char* message_erro = "You entered an incorrect option! \nEnter Y to continue or N to stop: ");
